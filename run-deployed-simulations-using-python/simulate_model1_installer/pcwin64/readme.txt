simulate_model1 MATLAB Python Package
...
2. Installing the simulate_model1 Package

A. Change to the directory that contains the file setup.py and the subdirectory 
simulate_model1. If you do not have write permissions, copy all its contents to a 
...
3. Using the simulate_model1 Package

The simulate_model1 package is on your Python path. To import it into a Python script or 
session, execute:

    import simulate_model1
