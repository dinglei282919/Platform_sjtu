gridattackpkg MATLAB Python Package
...
2. Installing the gridattackpkg Package

A. Change to the directory that contains the file setup.py and the subdirectory 
gridattackpkg. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the gridattackpkg Package

The gridattackpkg package is on your Python path. To import it into a Python script or 
session, execute:
